...
public class GUIMultiModel extends GUIPlugin implements PrismSettingsListener
{
	...
	private void setupActions()
	{
		...
		newPRISMModel.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_P);
		...
		newPEPAModel.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_E);
		...
		loadModel.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_O);
		...
		reloadModel.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_R);
		...
		saveModel.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_S);
		...
		saveAsModel.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_A);
		...
		parseModel.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_P);
		...
		buildModel.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_B);
		...
		exportStatesPlain.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_P);
		...
		exportStatesMatlab.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_M);
		...
		exportTransPlain.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_P);
		...
		exportTransMatlab.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_M);
		...
		exportTransDot.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_D);
		...
		exportTransDotStates.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_S);
		...
		exportTransMRMC.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_R);
		...
		exportStateRewardsPlain.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_P);
		...
		exportStateRewardsMatlab.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_M);
		...
		exportStateRewardsMRMC.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_R);
		...
		exportTransRewardsPlain.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_P);
		...
		exportTransRewardsMatlab.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_M);
		...
		exportTransRewardsMRMC.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_R);
		...
		computeSS.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_S);
		...
		computeTr.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_T);
		...
		exportSSPlain.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_P);
		...
		exportSSMatlab.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_M);
		...
		exportTrPlain.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_P);
		...
		exportTrMatlab.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_M);
		...
		viewStates.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_S);
		...
		viewTrans.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_T);
		...
		viewStateRewards.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_R);
		...
		viewTransRewards.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_E);
		...
		viewLabels.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_L);
		...
		viewPrismCode.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_V);
