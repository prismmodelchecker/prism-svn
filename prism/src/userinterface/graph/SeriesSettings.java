...
{	
  ...
  //  private SeriesDataSetting dataProp;    
	...
	public SeriesSettings(Graph graph, Graph.SeriesKey key)
	{
        ...
        showPoints = new BooleanSetting("show points", true, "Should points be displayed for this series?", this, true);
        ...
        showLines = new BooleanSetting("show lines", true, "Should lines be displayed for this series?", this, true);
        lineWidth = new DoubleSetting("line width",  1.0, "The line width for this series.", this, true, new RangeConstraint("0.0,"));
        String [] styles = { "---------", "- - - - -", "- -- - --" };
		...
		{			
			...
			{		
				...
				{ 
					...
					showPoints.setValue(pointsVisibleFlag == null || pointsVisibleFlag.booleanValue()); 
				}
				catch (SettingException e)
				{					
				}
				...
				{ 
					...
					showLines.setValue(linesVisibleFlag == null || linesVisibleFlag.booleanValue()); 
				}
				catch (SettingException e)
				{					
				}
