...
public class AxisSettings extends Observable implements SettingOwner
{
	...
	public AxisSettings(String name, boolean isDomain, Graph graph)
	{
		...
		showGrid = new BooleanSetting("show gridlines", true, "Should the gridlines be visible", this, true);
		...
		autoScale = new BooleanSetting("auto-scale", true, "When set to true, all minimum values, maximum values, grid intervals, maximum logarithmic powers and minimum logarithmic powers are automatically set and maintained when the data changes.", this, true);
		minValue = new DoubleSetting("minimum value", 0.0, "The minimum value for the axis", this, true);
		maxValue = new DoubleSetting("maximum value", 1.0, "The maximum value for the axis", this, true);
		gridInterval = new DoubleSetting("gridline interval", 0.2, "The interval between gridlines", this, false, new RangeConstraint(0, Double.POSITIVE_INFINITY, false, true));
		logBase = new DoubleSetting("log base", 10.0, "The base for the logarithmic scale", this, false, new RangeConstraint("1,"));
		
		minimumPower = new DoubleSetting("minimum power", 0.0, "The minimum logarithmic power that should be displayed on the scale", this, true);
		maximumPower = new DoubleSetting("maximum power", 1.0, "The maximum logarithmic power that should be displayed on the scale", this, true);
