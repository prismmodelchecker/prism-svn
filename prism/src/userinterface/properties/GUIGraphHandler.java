...
public class GUIGraphHandler extends JPanel implements MouseListener
{
	...
	private void initComponents()
	{
		...
		graphOptions.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_G);
		...
		zoomIn.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_I);
		...
		zoomOut.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_O);
		...
		zoomDefault.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_D);
		...
		importXML.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_I);
		...
		exportXML.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_X);
		...
		exportImageJPG.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_J);
		...
		exportImagePNG.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_P);
		...
		exportImageEPS.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_E);
		...
		exportMatlab.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_M);
		...
		printGraph.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_P);
		...
		deleteGraph.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_D);
