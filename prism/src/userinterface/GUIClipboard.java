...
public class GUIClipboard extends GUIPlugin
{
    ...
    private void setupActions()
    {
        ...
        actionUndo.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_U);
        ...
        actionRedo.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_R);
        ...
        actionCut.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_C);
        ...
        actionCopy.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_O);
        ...
        actionPaste.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_P);
        ...
        actionDelete.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_D);
        ...
        actionSelectAll.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_S);
